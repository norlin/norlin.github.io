...
/* global -app */
/* file: header.js */
(function(){dust.register("header/content",body_0);function body_0(chk,ctx){return chk.write("<div class=\"b-header_block b-header_block__first\"><h1 class=\"b-header_title").exists(ctx.getPath(false,["module","options","class"]),ctx,{"block":body_1},null).write("\">").reference(ctx.getPath(false,["module","content"]),ctx,"h",["s"]).write("</h1></div><div class=\"b-header_block b-header_block__second\"><a class=\"b-header_button\" href=\"/index\" data-type=\"route\">Готов помочь</a></div><div class=\"b-header_block\"><a class=\"b-header_button\" href=\"/page2\" data-type=\"route\">Нужна помощь</a></div><div class=\"b-header_right\"><div class=\"b-header_block\"></div><div class=\"b-header_block\"><!-- help --></div></div>");}function body_1(chk,ctx){return chk.write(" b-header_title__").reference(ctx.getPath(false,["module","options","class"]),ctx,"h");}return body_0;})();
/* file: content.dust */
...
(function ($, app) {
	...
	Map.prototype.resize = function () {
		...
		this.mapBlock.height(height - offset.top);
	...
	Map.prototype.ready = function () {
		...
		this.mapBlock = this.node.find('.b-map');
		//this.resize();
		...
		ymaps.ready(function () {
			module.map = new ymaps.Map(module.mapBlock[0], {
				center: [55.76, 37.64],
				zoom: 10
			});

			module.map.setType('yandex#publicMap');
		});
	};
} (jQuery, app));
/* global -app */
/* file: map.js */
(function(){dust.register("map/map",body_0);function body_0(chk,ctx){return chk.write("<div><div class=\"b-map\">").reference(ctx.getPath(false,["module","content"]),ctx,"h",["s"]).write("</div></div>");}return body_0;})();
/* file: map.dust */

/* end module map */
(function(){dust.register("page/index",body_0);function body_0(chk,ctx){return chk.helper("my",ctx,{"block":body_1},{"module":"title","hidden":"true"}).helper("my",ctx,{},{"module":"map"});}function body_1(chk,ctx){return chk.write("Готов помочь");}return body_0;})();
/* file: index.dust */
(function(){dust.register("page/page2",body_0);function body_0(chk,ctx){return chk.helper("my",ctx,{"block":body_1},{"module":"title"}).write("<div class=\"b-block\">Тут вы можете оставить заявку на помощь</div>");}function body_1(chk,ctx){return chk.write("Нужна помощь");}return body_0;})();
/* file: page2.dust */
/* global app */
(function (window, $, app) {
...
/* global -app */(function(){dust.register("index",body_0);function body_0(chk,ctx){return chk.helper("my",ctx,{"block":body_1},{"module":"header"}).helper("my",ctx,{},{"module":"router"}).helper("my",ctx,{},{"module":"footer","sticked":"true"}).helper("my",ctx,{},{"module":"loader"});}function body_1(chk,ctx){return chk.write("Твори добро");}return body_0;})();